        ...
        <div className="bg-white rounded-xl shadow-2xl border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 space-y-3">
              ...
              <p className="text-sm text-red-900 font-medium pt-2 border-t border-red-200">
            ...
            <div>
              ...
              <input
                ...
                className="block w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors"
                disabled={isDeleting}
                autoFocus
              />
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <button
                ...
                className="px-5 py-2.5 text-sm font-medium text-white bg-red-600 border border-transparent rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                {isDeleting ? (
