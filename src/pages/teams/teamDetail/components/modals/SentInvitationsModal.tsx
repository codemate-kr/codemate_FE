  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        {/* 모달 */}
        <div className="relative w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-gray-200 dark:border-slate-800">
          {/* 헤더 */}
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-slate-800">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100">초대 현황</h2>
                {!loading && (
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 px-6">
                <div className="w-14 h-14 bg-gray-100 dark:bg-slate-800 rounded-full flex items-center justify-center mb-4">
                  <UserPlus className="w-7 h-7 text-gray-400 dark:text-slate-500" />
                </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="flex-shrink-0 px-3 py-1.5 text-xs font-medium text-gray-600 dark:text-slate-300 hover:text-red-600 bg-gray-100 dark:bg-slate-800 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors disabled:opacity-50"
                      >
                        {isCanceling ? (
          ...
          <div className="px-5 py-4 border-t border-gray-100 dark:border-slate-800">
            <button
              onClick={onClose}
              className="w-full py-2.5 text-sm font-medium text-gray-700 dark:text-slate-300 bg-gray-100 dark:bg-slate-800 hover:bg-gray-200 dark:hover:bg-slate-700 rounded-xl transition-colors"
            >
              닫기
            </button>
          </div>
